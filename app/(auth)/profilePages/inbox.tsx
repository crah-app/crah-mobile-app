...
import FriendRequestColumn from '@/components/FriendRequestColumn';
import UpdateInformationColumn from '@/components/UpdateInformationColumn';

// dummy data. replace with database data
import UpdateInformation from '@/JSON/update_information_modal_content.json';
import RankColumn from '@/components/InboxRankColumn';
